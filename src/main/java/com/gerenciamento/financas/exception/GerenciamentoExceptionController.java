...
public class GerenciamentoExceptionController {

    @ExceptionHandler(MethodArgumentNotValidException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorHandlingFields handleMethodArgumentException(MethodArgumentNotValidException exception,
    ...
    public ResponseEntity<ErrorHandling> handleUserException(BadRequestException exception,
            HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(
                        new ErrorHandling(LocalDateTime.now(), HttpStatus.BAD_REQUEST.value(), request.getServletPath(),
                                request.getMethod(),
    ...
    public ResponseEntity<ErrorHandling> handleUserException(GerenciamentoException exception, HttpServletRequest request) {
    ...
    public record ErrorHandlingFields(LocalDateTime timestamps, Integer statusCode, String message, String path,
            String method, Map<String, String> errors) {
    }
